...
I'm a curious, driven Data Science enthusiast pursuing my **B.Tech at KCC Institute of Technology and Management** (Graduating 2027). I love diving into messy real-world problems and turning raw data into insights that actually matter — whether it's building predictive models, designing clean dashboards, or exploring how AI fits into everyday life.

- 🔭 Currently working on **Data Science & Analytics projects**
- 🌱 Exploring **LLMs, Prompt Engineering, and AI-driven solutions**
- 💡 Passionate about connecting tech with real-world impact
...
| Area | Skills |
|------|--------|
| Data Framework | Data Modeling · Data Lineage · EDA |
...
### 🏥 Clinisight Insight Hub *(Oct 2025 – Dec 2025)*

> A healthcare analytics dashboard built using **Databricks, SQL, and Power BI** to transform raw medical data into meaningful insights.

- 📊 Interactive analysis of patient trends, hospital performance, and revenue patterns
- 🏗️ Built end-to-end data pipeline with cleaning, transformation, and KPI design
- 🤖 Designed with future **AI/ML integration** in mind for predictive capabilities
- 🎯 Supports data-driven decision-making across the healthcare sector

**Tech Stack:** `Databricks` `SQL` `Power BI` `Business Intelligence` `Data Transformation`
...
|--------|------------|------|
| B.Tech | KCC Institute of Technology and Management | 2023 – 2027 |
